      ...
      <div className="max-w-4xl mx-auto px-8 text-center relative z-10">
        ...
        >
          {[
            ...
            { icon: '⌂', label: 'GitHub', href: 'https://github.com/abhijithabhi01', gradient: 'linear-gradient(135deg, #47e8ff 0%, #e8ff47 100%)', target: 'blank' },
            { icon: 'in', label: 'LinkedIn', href: 'https://www.linkedin.com/in/abhijithsreekumar-dev/', gradient: 'linear-gradient(135deg, #e8ff47 0%, #47e8ff 100%)', target: 'blank' },
    ...
    >
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          >
            © 2026 Abhijith Sreekumar — Built with{' '}
            <span 
              style={{
                background: 'linear-gradient(135deg, #e8ff47 0%, #47e8ff 100%)',
                WebkitBackgroundClip: 'text',
